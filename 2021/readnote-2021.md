...
1. **社会认知理论**：
   - **归因理论**：探讨人们如何解释他人和自己行为的原因，如海德的二因论（内部归因 vs. 外部归因）、韦纳的三维归因理论（能力、努力、运气等维度）。
2. **社会影响理论**：
   - **从众理论**：研究个体在面临群体压力时改变自己观点、行为以顺应多数人的现象，如阿希的从众实验、谢里夫的规范形成研究。
   - **顺从与服从理论**：区分了在直接请求下改变行为（顺从）与在权威命令下违背个人意愿行事（服从），如米尔格拉姆的电击实验揭示了权威对个体行为的巨大影响。
3. **社会认同理论**：
   - **自我归类理论**：当个体把自己归入某个群体时，群体身份会影响其态度、行为和自我评价，如泰菲尔和特纳的社会认同理论。
4. **社会比较理论**：
   - **费斯汀格的社会比较理论**：个体有评估自己能力和地位的内在驱力，会通过与他人比较来确定自我价值。
5. **社会学习理论**：
   - **班杜拉的社会学习理论**：强调观察、模仿和强化在个体习得社会行为中的作用，包括直接强化、替代强化和自我强化。
6. **态度与行为转变理论**：
   - **认知失调理论**：由费斯汀格提出，描述了当个体的信念、态度与行为之间出现不一致时，会产生心理不适，并力求通过改变信念、态度或行为来恢复一致性。
7. **群体动力理论**：
   - **群体极化理论**：群体讨论后，群体成员的观点往往会向某一极端方向移动，比个体初始立场更为极端。
   - **群体思维理论**：群体决策过程中，追求一致性和维护群体凝聚力可能导致批判性思考下降，过度乐观和冒险行为增加。
8. **社会交换理论**：
   - **霍曼斯的社会交换理论**：认为人际关系和群体行为基于成本与收益的权衡，人们寻求最大化自己的收益并最小化成本。
9. **偏见与歧视理论**：
   - **现实群体冲突理论**：谢里夫等人提出，群体间的竞争和资源分配不公导致偏见与歧视。
   - **社会身份理论**：个体通过所属群体的身份来定义自己，群体间的差异可能导致偏见和歧视。
10. **冲突与和解理论**：
    - **冲突螺旋理论**：描述冲突如何通过一系列反馈机制不断升级的过程。
    - **冲突解决策略**：如谈判、调解、仲裁、和解等理论框架，旨在分析和指导冲突的有效管理与和平解决
